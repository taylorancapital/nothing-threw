...
after go-live.** Fixed 2026-06-07 (`f58e9073`, labeled P1 and P2):
...
**Anchor:** commit `f58e9073` (2026-06-07, `Co-Authored-By: Claude Opus
4.8`). The gap traces to the original 3DS/trial-enrollment build around
2026-05-22–23 (`f10ea2d0`, `b58f29d1`).
...
`036d7837` (2026-06-09, 10:37 EDT) installed Facebook Pixel and Google Ads
...
Fixed the same day, `60678a66` (2026-06-09, 14:48 EDT) — a 4-hour-11-minute
...
**Anchor:** commits `036d7837` and `60678a66`, both 2026-06-09,
...
itself.** `a95b231a` (2026-06-22) added `public/city.html`. Two FAQ entries
...
Fixed the same day, `556c7122` (2026-06-22).
...
**Anchor:** commits `a95b231a` and `556c7122`, both 2026-06-22,
`Co-Authored-By: Claude Opus 4.8`.
